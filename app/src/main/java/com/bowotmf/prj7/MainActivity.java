...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.invalidate();
        startMarker.setIcon(getResources().getDrawable(R.drawable.ico2));
        ...
        map.invalidate();
        startMarker2.setIcon(getResources().getDrawable(R.drawable.ico3));
        ...
        map.invalidate();
        startMarker3.setIcon(getResources().getDrawable(R.drawable.ico5));
        ...
        GeoPoint startPoint5 = new GeoPoint(-5.383526,105.249887);
